...
import com.ch.android.cssdk.ImageCache;
import com.ch.android.cssdk.R;
import com.ch.android.cssdk.adapter.MessageAdapter;
import com.ch.android.cssdk.util.KeFuUtils;
...
public class ChatRowImage extends ChatRowFile{
    ...
    protected void onBubbleClick() {
        ...
        ARouter.getInstance()
                .build("/browse/ImageBrowseActivity")
                .withBundle("fromKeFu",bundle)
                .navigation(context);
