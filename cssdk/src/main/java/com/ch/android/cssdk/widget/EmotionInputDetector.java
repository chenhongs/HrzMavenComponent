package com.ch.android.cssdk.widget;
...
import com.ch.android.cssdk.util.AudioRecoderUtils;
import com.ch.android.cssdk.util.PopupWindowFactory;
import com.ch.android.cssdk.util.Utils;
    ...
    public EmotionInputDetector bindToSendButton(TextView sendButton) {
        ...
        sendButton.setOnClickListener(v -> {
            ...
            if(TextUtils.isEmpty(content)){
                Toast.makeText(mActivity,mActivity.getString(R.string.kefu_send_not_empty),Toast.LENGTH_SHORT).show();
                return;
            }
...
//                EventBus.getDefault().post(messageInfo);
    ...
    private void showEmotionLayout() {
        ...
        hideSoftInput();
//        mEmotionLayout.getLayoutParams().height = ViewPager.LayoutParams.WRAP_CONTENT;
    ...
    protected void sendTextMessage(String content) {
        if (content != null && content.length() > 1500){
            Toast.makeText(mActivity, R.string.message_content_beyond_limit, Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        ChatClient.getInstance().chatManager().sendMessage(message, new Callback() {
            ...
            public void onProgress(int progress, String status) {
                Log.d("sendMessage","progress:"+status);
            }
        });
