...
import com.ch.android.cssdk.adapter.EmotionGridViewAdapter;
import com.ch.android.cssdk.adapter.EmotionPagerAdapter;
import com.ch.android.cssdk.base.BaseFragment;
import com.ch.android.cssdk.util.EmotionUtils;
import com.ch.android.cssdk.util.GlobalOnItemClickManagerUtils;
import com.ch.android.cssdk.util.Utils;
import com.ch.android.cssdk.widget.IndicatorView;
...
public class ChatEmotionFragment extends BaseFragment {
    ...
    private void initEmotion() {
        ...
        // item的间距
        int spacing = Utils.dp2px(getActivity(), 8);
        // 动态计算item的宽度和高度
