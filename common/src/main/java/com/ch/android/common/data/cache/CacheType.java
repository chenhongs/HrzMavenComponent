...
package com.ch.android.common.data.cache;
...
public interface CacheType {
    ...
    int RESOURCE_SERVICE_CACHE_TYPE_ID=5;
    int DB_SERVICE_CACHE_TYPE_ID=6;
    ...
    CacheType DB_SERVICE_CACHE = new CacheType() {
        private static final int MAX_SIZE = 150;
        private static final float MAX_SIZE_MULTIPLIER = 0.002f;

        @Override
        public int getCacheTypeId() {
            return DB_SERVICE_CACHE_TYPE_ID;
        }
    ...
    /**
     * {@link RepositoryManager}中存储 Resource Service 的容器
     */
    CacheType RESOURCE_SERVICE_CACHE = new CacheType() {
        private static final int MAX_SIZE = 150;
        private static final float MAX_SIZE_MULTIPLIER = 0.002f;

        @Override
        public int getCacheTypeId() {
            return RESOURCE_SERVICE_CACHE_TYPE_ID;
        }
