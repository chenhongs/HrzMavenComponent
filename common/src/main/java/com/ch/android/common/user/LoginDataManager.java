package com.ch.android.common.user;
...
import com.ch.android.common.data.sp.SharePreferenceHelper;
import com.ch.android.common.entity.AddressBean;
...
public class LoginDataManager {
    ...
    private LoginDataManager(Context context) {
        sharedPreferences = new SharePreferenceHelper(context).getSharedPreferences(LOGIN_XML_FILE_NAME);
    }
     ...
     */
    public int getLevel() {
        return sharedPreferences.getInt(USER_INFO_LEVEL, Consts.UserLevel.LEVEL_FANS);
    }
