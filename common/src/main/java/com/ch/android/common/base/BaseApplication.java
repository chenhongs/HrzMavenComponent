...
import com.ch.android.common.base.delegate.AppDelegate;
...
import com.ch.android.common.util.app.AppInfoUtils;
import com.ch.android.common.util.app.AppTaskUtil;
import com.ch.android.common.util.app.PhonePlatformUtil;
import com.ch.android.common.util.SpUtil;
...
public class BaseApplication extends Application implements App {
    ...
    public void onCreate() {
        ...
        Log.d("hrz_process", "BaseApplication process name: " + prorcessName);

        if (PROCESS_HRZ_MAIN.equals(prorcessName)) {
            Log.d("hrz_process", "BaseApplication init main process");
