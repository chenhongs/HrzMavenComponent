...
import com.ch.android.common.configuration.GlobalHttpHandlerImpl;
import com.ch.android.common.configuration.MyGsonConfiguration;
import com.ch.android.common.configuration.MyRxCacheConfiguration;
...
//    public static String sDomain = Api.APP_DOMAIN;
    ...
    public void applyOptions(Context context, GlobalConfigModule.Builder builder) {
        if (!true) { //Release 时,让框架不再打印 Http 请求和响应的信息
            builder.printHttpLogLevel(RequestInterceptor.Level.NONE);

            //不再打印信息
            builder.androidLogAdapter(new AndroidLogAdapter(){
                @Override
...
//                });
    ...
    public void injectActivityLifecycle(Context context, List<Application.ActivityLifecycleCallbacks> lifecycles) {
        ...
        // 可以根据不同的逻辑添加多个实现类
        Logger.e("xxfasfasfasfasfqweqweq");
